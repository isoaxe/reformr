This route contains a page for each medical question. The naming convention is as follows:

wmXX
w => Weight loss quiz. This is to allow for other quizzes related to more products in the future.
m => Medical quiz. This differentiates it from the screening quiz and other quiz types that may be introduced in the future.
XX => An integer beginning at 01. Increments with each new question.

Current question list:
Question 01 => wm01-what-motivates-you
