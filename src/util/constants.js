...
const isLocalClient = isClient && window.location.hostname === 'localhost';
const isLocalServer = process.env.HOST === 'localhost';
export const isLocal = isLocalClient || isLocalServer;
